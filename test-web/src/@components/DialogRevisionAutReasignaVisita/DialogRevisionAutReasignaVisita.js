...
import {
  ...
  getActoAdmin,
  getPreview,
  createActoAdminReview,
} from '../../app/main/apps/RolFuncionario/solicitudes/store/autoReasignacionVisitaSlice';
...
const DialogRevisionCambioSolicitante = (props) => {
  const {
    open,
  ...
  const handleViewDocument = async () => {
    ...
    const response = await dispatch(getPreview(body));
        ...
        >
          ...
          {status === 4 && disableCode && (
            <CoomonFirmaAdministrativo
              ...
              titleFirma="Firma de Auto Reasignación de Visita"
            />
          )}
          <div className="flex">
            {/* {status === 2 || status === 4 ? (
            ...
            <div className="flex">
              <div className="mr-10">
                <CustomButton
                  ...
                  disabled={arrayFix?.length === 0 && (itemCorreciones && itemCorreciones.acto_correccion.length === 0)}
                />
              </div>
              <div className="mr-12">
                <CustomButton
...
export default DialogRevisionCambioSolicitante;
