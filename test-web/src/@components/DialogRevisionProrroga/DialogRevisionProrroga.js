...
import { getPreviewDocumentProrroga } from 'app/main/apps/RolFuncionario/solicitudes/store/ProrrogaSlice';
...
const DialogRevisionProrroga = (props) => {
  const {
    open,
  ...
  return (
    <Dialog open={open} fullScreen className={classes.screenDialog}>
      ...
      <div className="py-14 px-20 min-w-full ">
          ...
          <div className="w-full  h-full flex">
            ...
            <div className="w-1/4 p-12 ml-6">
              <Typography className="text-primary mb-5">
                <span className="font-bold" style={{ color: '#145C9C' }}>
                  Dias calendario de prórroga solicitados:
                </span>
              </Typography>
              <div
                className="flex justify-between p-10 border-dashed border-1 rounded-12 items-center mb-16"
                style={{ backgroundColor: '#FFF6D6', borderColor: '#FCC500' }}
              >
                <Typography className="text-primary font-bold">
                  {dataProrroga?.dias_prorroga} dias
                </Typography>
                <Typography
                  style={{
                    color: `${
            ...
            <div className="flex">
              <div className="mr-10">
                <CustomButton
                  ...
                  disabled={arrayFix?.length === 0 && itemGestion?.ss_paso_actual !== 4}
                />
              </div>
              <div className="mr-12">
                <CustomButton
...
export default DialogRevisionProrroga;
