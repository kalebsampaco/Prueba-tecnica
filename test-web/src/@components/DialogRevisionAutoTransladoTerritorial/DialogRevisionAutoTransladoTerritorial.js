...
import { getPreviewActoAdminTransladoTerritorial } from '../../app/main/apps/RolFuncionario/solicitudes/store/autoTransladoTerritorialSlice';
...
const DialogRevisionAutoTransladoTerritorial = (props) => {
  const {
    open,
  ...
  const handleViewDocument = async () => {
    ...
    const response = await dispatch(getPreviewActoAdminTransladoTerritorial(body));
        ...
        >
          <div className="mb-16 flex justify-between">
            <div>
              ...
              <Typography className="text-primary">
                <span className="font-bold">Fuente:</span> Auto traslado territorial
              </Typography>
            </div>
            <div>
              <div
...
export default DialogRevisionAutoTransladoTerritorial;
