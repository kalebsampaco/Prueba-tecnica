...
const DialogRevisionRequer = (props) => {
  const {
    open,
        ...
        >
          <div className="mb-16 flex justify-between">
            <div>
              ...
              <Typography className="text-primary w-3/4">
            ...
            <div>
              ...
              {fixes && (
                <div
                  className="border-dashed border-1 p-10 flex w-full rounded-12 "
                  style={{
                ...
                >
                  ...
                  <div>
                    <Typography className="font-bold" style={{ color: '#364A5D' }}>
                      ¡Hola, el Subdirector jurídico ha solicitado corregir éste documento!
                    </Typography>
                    <br />
                    <Typography className="font-semibold" style={{ color: '#364A5D' }}>
                      Por favor verifique el documento con las siguientes{' '}
          ...
          {status === 4 && disableCode && (
            <CoomonFirmaAdministrativo
              ...
              titleFirma="Firma del Auto requerimiento"
            />
          )}
          <div className="flex">
            {status === 4 && (
            ...
            <div className="flex">
              <div className="mr-10">
                <CustomButton
                  ...
                  disabled={arrayFix?.length === 0 && !fixes}
                />
              </div>
              <div className="mr-12">
                <CustomButton
...
export default DialogRevisionRequer;
