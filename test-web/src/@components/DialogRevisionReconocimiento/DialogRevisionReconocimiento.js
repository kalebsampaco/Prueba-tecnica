...
import { getPreviewReconocimiento } from '../../app/main/apps/RolFuncionario/solicitudes/store/tercerIntervinienteSlice';
...
const DialogRevisionReconocimiento = (props) => {
  const {
    open,
        ...
        >
          ...
          {status === 4 && disableCode && (
            <CoomonFirmaAdministrativo
              ...
              titleFirma="Firma de Auto Reconocimiento"
            />
          )}
          <div className="flex">
            {/* {status === 2 || status === 4 ? (
...
export default DialogRevisionReconocimiento;
