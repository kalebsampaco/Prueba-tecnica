...
import { getPreviewActoAdminTransladoTerritorialDestino } from '../../app/main/apps/RolFuncionario/solicitudes/store/autoTransladoTerritorialSlice';
...
const DialogRevisionAutoTransladoTerritorialDestino = (props) => {
  const {
    open,
  ...
  const handleViewDocument = async () => {
    const body = {
      ...
      aa_cuerpo_doc: itemActoAdm?.aa_cuerpo_doc,
    };
    const response = await dispatch(getPreviewActoAdminTransladoTerritorialDestino(body));
              ...
              <div className="mb-32">
                <Typography style={{ color: '#FF4D4D' }} className="mb-8">
                  {itemCorreciones?.aa_fecha_creacion
                    ...
                    : ''}
                  - Autor: {itemCorreciones?.fk_firmante?.cli_usuario?.cu_nombres}{' '}
                  {itemCorreciones?.fk_firmante?.cli_usuario?.cu_apellidos}{' '}
                </Typography>
                <div
        ...
        >
          <div className="mb-16 flex justify-between">
            <div>
              ...
              <Typography className="text-primary">
                <span className="font-bold">Fuente:</span> Auto traslado de territorial
              </Typography>
            </div>
            <div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <Typography className="font-semibold" style={{ color: '#364A5D' }}>
                    Por favor actualice el documento con las siguientes{' '}
                    <strong>correcciones</strong> solicitadas por{' '}
                    {itemCorreciones?.fk_firmante?.cli_usuario?.cu_nombres}{' '}
                    {itemCorreciones?.fk_firmante?.cli_usuario?.cu_apellidos}:
                  </Typography>
          ...
          {status === 4 && disableCode && (
            <CoomonFirmaAdministrativo
              ...
              titleFirma="Firma de Auto Traslado Territorial"
            />
          )}
          <div className="flex">
            {/* {status === 2 || status === 4 ? (
            ...
            <div className="flex">
              <div className="mr-10">
                <CustomButton
                  ...
                  disabled={
                    arrayFix?.length === 0 &&
                    (itemCorreciones == undefined || itemCorreciones?.acto_correccion?.length === 0)
                  }
                />
              </div>
              <div className="mr-12">
              ...
              {status === 2 && (
                <div>
                  <CustomButton
                    ...
                    disabled={
                      arrayFix?.length > 0 ||
                      (itemCorreciones && itemCorreciones.acto_correccion.length > 0)
                    }
                  />
                </div>
              )}
...
export default DialogRevisionAutoTransladoTerritorialDestino;
